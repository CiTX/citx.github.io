AddSRModeBtn = $('<span id="add-sr-mode-btn" class="btn btn-sm btn-default" title="Открыть форму для добавления"><img src="https://sovetromantica.com/favicon.ico?sovet2chantica" style="height: 16px"/></span>').insertAfter("#showmediaurl").on("click", function() {
if (!$(this).hasClass('btn-success')) {
$(this).addClass('btn-success').html('<span title="Закрыть форму"><img src="https://sovetromantica.com/favicon.ico?sovet2chantica" style="height: 16px"/></span>');
...
$(this).removeClass('btn-success').html('<span title="Открыть форму для добавления"><img src="https://sovetromantica.com/favicon.ico?sovet2chantica" style="height: 16px"/></span>');
$('#sr-form').remove();}
  });
