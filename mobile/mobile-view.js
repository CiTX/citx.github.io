...
$(`#mobile-menu`).remove();
$(`<div id="mobile-menu" style="text-align: center;position: fixed;top: 0px;max-width: calc(100vw - 150px);width: 100%;max-height: 50px;height: 50px;z-index: 1030;left: 70px;">
